...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $categoriesProduct->category_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $categoriesProduct->category_id)]
            )
        ?></li>
...
<div class="categoriesProducts form large-9 medium-8 columns content">
