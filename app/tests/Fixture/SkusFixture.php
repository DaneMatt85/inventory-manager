...
class SkusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sku' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'price' => 1,
                'quantity' => 1,
                'created' => '2018-12-08 09:31:19',
                'modified' => '2018-12-08 09:31:19'
            ],
        ];
        parent::init();
    }
